...
start:
	...
	case *ast.SwitchStatement:
		b.switchStatement(fn, stmt, label)
...
func (b *builder) switchStatement(fn *Function, stmt *ast.SwitchStatement, label *lblock) {
	...
	if label != nil {
		// switchStatement is processing a labeled statement, so we set the break jump.
		label._break = done
	}
